                        ...
                        <div class="container-elements clearfix">
                            ...
                            <div class="col-md-12">
                               <div class="economy-content--wrapper">
                                   ...
                                   <br>
                                   <form action="include/submit_email.php" method="POST" name="questions_form" id="questions_form">
                                       <div class="row">

                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   <label for="" class="required-field">Имя</label>
                                                   <input type="text" class="form-control" name="recipient_name" id="recipient_name" placeholder="например: Виктория Сергеевна" required>
                                               </div>
                                               <div class="form-group">
                                                   <label for="recipient_email" class="important-field">E-mail</label>
                                                   <input type="email" name="recipient_email" id="recipient_email" placeholder="например: test@gmail.com" class="form-control" required>
                                               </div>
                                           ...
                                           <div class="col-md-6">
                                               <div class="form-group">
                                                   ...
                                                   <textarea name="recipient_question" id="recipient_question" cols="30" rows="10" class="form-control" required placeholder=""></textarea>
                                               </div>
