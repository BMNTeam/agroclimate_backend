...
$title = 'Анализ динамики агроклиматических условий возделывания ранних яровых колосовых (показатель С.А. Сапожниковой)';
                ...
                <div class="col-md-12">
                    ...
                    <div class="block-container clearfix last-container">
                        ...
                        <div class="container-elements clearfix">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <form action="sapojnikova.php" method="POST">
                                        <div class="col-md-6">
                                            ...
                                            <div class="get-period--form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="temperature_forecast">Прогнозируемое значение показателя С.А. Сапожниковой: </label>
                                                ...
                                                if(isset($year_slide) && $year_slide != "")
                                                {
                                                    ...
                                                    while($row_tp = mysqli_fetch_array($query_result_tp))
                                                    {
                                                        ...
                                                        if($row_tp["P5"] != "" && $row_tp["P6"] != "" && $PrevP[$CountYear] != "" && $row_tp["T5"] != "" && $row_tp["T6"] != "")
                                                        {
                                                            ...
                                                            $SapValue = (0.4 * ($PrevP[$CountYear]) + ($row_tp["P5"] + $row_tp["P6"])) / (0.18 * (($row_tp["T5"] * 31) + ($row_tp["T6"] * 30)));
                                                            $CountYear++;
                                                        }

                                                        $PerYearValue[$CurYear + $CountProcessedRows] = $SapValue;
                                                    ...
                                                    $CHT_Slide = "Динамика коэффициента С.А. Сапожниковой. Метеостанция: ".$Meteostations[$meteo_id];
    ...
    if(isset($year_slide))
    {
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                chart.draw(data, {width: 1100, height: 600, title: 'Динамика агроклиматических условий возделывания ранних яровых колосовых. Метеостанция: <? echo $Meteostations[$meteo_id];?> (скользящие <? echo $year_slide;?> летние)',
                    colors:['#b600b0'],
                    hAxis: {title: 'Период', titleTextStyle: {color: '#000000'}, slantedTextAngle: 90, textStyle: {color: '#a9a9a9', fontSize: 14}},
                    vAxis: {title: 'Значение показателя С.А. Сапожниковой', titleTextStyle: {color: '#000000'}, slantedTextAngle: 90, textStyle: {color: '#a9a9a9', fontSize: 14}},
                    pointSize: 6,
                    legend: "bottom",
                    curveType: "function"
                });
