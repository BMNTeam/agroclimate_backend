...
$title = 'Анализ динамики температуры воздуха';
$heading = 'Страница анализа динамики температуры воздуха';
                        ...
                        <div class="container-elements clearfix">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <form action="temperature_dynamic.php" method="POST">
                                        <div class="col-md-12">
                                            ...
                                            <div class="get-period--form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="temperature_forecast">Прогнозируемое значение температуры воздуха: </label>
                                                    <input required type="text" placeholder="например: 10,5"
                                                ...
                                                if(isset($year_slide) && $year_slide != "")
                                                {
                                                    ...
                                                    while($row_tp = mysqli_fetch_array($query_result_tp))
                                                    {
                                                        ...
                                                        if($MeanT != -100)
                                                        {
                                                            $CountProcessedRows++;
                                                            $MeanT /= $Count_Months;
                                                            $PerYearValue[$CurYear + $CountProcessedRows] = $MeanT; //массив ежегодных данных по температуре
                                                        }
                                                    }
                                                    ...
                                                    $CHT_Slide = "Динамика температуры воздуха. Метеостанция: ".$meteo_title[$Selected_Meteo_ID - 1];
    ...
    if(isset($year_slide))
    {
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                chart.draw(data, {width: 1200, height: 700, title: 'Динамика температуры воздуха. Метеостанция: <? echo $Meteostations[$meteo_id];?> (скользящие <? echo $year_slide;?> летние значения)',
                    colors:['#b60000'],
                    hAxis: {title: 'Период', titleTextStyle: {color: '#000000'}, slantedTextAngle: 90, textStyle: {color: '#a9a9a9', fontSize: 16}},
                    vAxis: {title: 'Температура воздуха, градусов Цельсия.', titleTextStyle: {color: '#000000'}, slantedTextAngle: 90, textStyle: {color: '#a9a9a9', fontSize: 16}},
                    pointSize: 6,
                    legend: "bottom",
                    curveType: "function"
                });
