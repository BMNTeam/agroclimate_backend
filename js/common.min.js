...
//END Registration form
  ...
  $('.toggle-agrarian-year').click(function remplaceMonthsNames() {
    const usualYear = ["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"];
    const agroYear = ["Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь", "Январь", "Февраль", "Март", "Апрель", "Май", "Июнь"];
    labels = document.querySelectorAll('.simple_text');
    labels.forEach((l, i) => l.innerHTML = this.checked ? agroYear[i] : usualYear[i])
  });
