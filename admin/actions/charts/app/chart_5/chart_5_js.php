...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        // Set chart options
        var options = {
            'title': "Климадиаграмма: <?php echo( $first_region[ 'region_name' ])?> период <?php echo( $first_region[ 'years' ]).". ".$first_region['desc'];?>",
            'width': 1100,
            'height': 600,
            legend: 'none',
            vAxes: {
              // Adds titles to each axis.
              0: {title: 'Температура воздуха, °C', viewWindow: {min: -10, max: 40}},
              1: {title: 'Количество осадков, мм.', viewWindow: {min: -20, max: 80}}
            },
        ...
        function placeSummaryOverlay ( dataTable ) {
            ...
            var legendElement               = document.querySelectorAll('#chartLegend')[0];
            var fullChart                   = document.querySelectorAll('.chart--wrapper')[0];
            console.dir(fullChart);
        ...
        function fixChartSize( legendElement, fullChart ) {
          fullChart.style.minHeight = fullChart.clientHeight +25+'px';
        }
        ...
        var chart = new google.visualization.LineChart(document.getElementById('<?echo "chart_div".$chart_num;?>'));
